    ...
    return (
        <div className='grid grid-cols-2 bg-[#D1D8EA] items-center justify-center h-4/6'>
            <div className='md:m-20 m-5'>
                ...
                <Link to="/Signup" className="btn bg-[#51DACF] md:mt-5 mt-2 border-none md:btn-md btn-sm md:px-5 px-2 text-white">Let’s Explore<MdArrowOutward className='text-lg'/></Link>
            </div>
